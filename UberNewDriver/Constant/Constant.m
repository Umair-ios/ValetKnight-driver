...
NSString *const PREF_LATER=@"later";
...
NSString *const PREF_USER_PIC=@"picture";
NSString *const PREF_TIME_TO_RESPOND=@"time_left_to_respond";
NSString *const PREF_IS_NEW_REQ_PUSH=@"isNewRequestPush";
NSString *const PREF_IS_CANCEL_REQ_PUSH=@"isCancelRequestPush";

NSString *strowner_lati;
NSString *strowner_longi;
NSString *strDrop_lati;
NSString *strDrop_longi;
