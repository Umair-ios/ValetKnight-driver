...
//#define API_URL @"http://taxinow.xyz/"
//#define PRIVACY_URL @"http://taxinow.xyz/termsncondition"

#define API_URL @"http://52.26.255.47/"
...
extern NSString *const PREF_LATER;
...
extern NSString *const PREF_USER_PIC;
extern NSString *const PREF_TIME_TO_RESPOND;
extern NSString *const PREF_IS_NEW_REQ_PUSH;
extern NSString *const PREF_IS_CANCEL_REQ_PUSH;
...
extern NSString *strDrop_lati;
extern NSString *strDrop_longi;
...
extern NSString *const PARAM_TIME_ZONE;//timezone
...
extern NSMutableDictionary *dictOwner;
